...
function startEditing(permiso) {
    ...
    editarPermiso.estado = permiso.justificado
                    ...
                    <div class="card p-3 col-12">
                        <form @submit.prevent="saveChanges">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarPermiso.fecha}} id="fecha" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarPermiso.causa}} id="causa"
                                       type="text"
                                       @keyup.enter="botonPulsado()"
                            ...
                            <div class="mb-3">
                                <input class="form-check-input" type="checkbox" id="esatado"
