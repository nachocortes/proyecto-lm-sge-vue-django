                    ...
                    <div class="card p-3 col-12">
                        <form @submit.prevent="saveChanges">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarDepartamento.nombre}} id="nombre" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarDepartamento.telefono}} id="telefono" type="text"
                                       @keyup.enter="botonPulsado()"
