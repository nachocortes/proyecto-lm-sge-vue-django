...
function startEditing(ausencia) {
    ...
    editarAusencia.justificado = ausencia.justificado
        ...
        <div class="col col-10">
            <table v-if="ausencias.items.length" class="table table-responsive table-striped">
                ...
                <tr v-for="ausencia in ausencias.items" :key="ausencia.id">
                    ...
                    <td>{{ ausencia.justificado ? "Sí" : "No" }}</td>
                    ...
                    <div class="card p-3 col-12">
                        <form @submit.prevent="saveChanges">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarAusencia.fecha}} id="fecha" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarAusencia.motivo}} id="motivo"
                                       type="text"
                                       @keyup.enter="botonPulsado()"
                            ...
                            <div class="mb-3">
                                <input class="form-check-input" type="checkbox" id="justificado"
                                       v-model="editarAusencia.justificado">
