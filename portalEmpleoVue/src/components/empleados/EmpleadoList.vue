                    ...
                    <div class="card p-3 col-12">
                        <form @submit.prevent="saveChanges">
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarEmpleado.nombre}} id="nombre" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarEmpleado.apellido}} id="apellido" type="text"
                                       @keyup.enter="botonPulsado()"
                                ...
                                <input class="form-control" placeholder={{editarEmpleado.dni}} id="dni" type="text"
                                       @keyup.enter="botonPulsado()"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" placeholder={{editarEmpleado.edad}} id="edad" type="text"
                                       @keyup.enter="botonPulsado()"
