        ...
        <div class="card p-3 col-12">
            ...
            <div v-if="selectedDepartamentoUrl !== null">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" placeholder="Escribe algo..." id="apellido" type="text"
                           @keyup.enter="botonPulsado()"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" placeholder="Escribe algo..." id="dni" type="text"
                           @keyup.enter="botonPulsado()"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" placeholder="Escribe algo..." id="edad" type="text"
                           @keyup.enter="botonPulsado()"
